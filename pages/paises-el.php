...
<head>
  ...
  <title>Países que usam energia limpa</title>
</head>
...
<body>
  ...
  <div class="row">
    <div class="col s12 m9">
      ...
      <div class="divider"></div>
      <div class="section center-align" id="quenia">
        <h5>Quénia</h5>
        <img src="../img/paises-el/bandeira-quemia.png" width="60%" alt="">
        <p>O Quênia é o líder global em números de sistemas de energia solar instalados por habitante, e pretende ser totalmente abastecido por energia renovável em breve e levar eletricidade a toda população. Inclusive é lá que está localizado o maior parque eólico africano. Mais quenianos estão optando pela energia solar a cada ano, ao invés de se conectar a rede elétrica do país. A explicação para esse fenômeno são os altos custos da conectividade e o fato de que existe energia solar em abundância no Quênia. Em geral, o Quénia é considerado um exemplo na África no que diz respeito às questões de proteção ao ambiente. O país pretende reduzir seus gases de efeito estufa em 30% até 2035.</p>
      </div>
      <div class="divider"></div>
      <div class="section" id="africa">
        <h5>A África do Sul utiliza energia limpa</h5>
        <img src="../img/paises-el/africa-do-sul.png" width="60%" alt="bandeira da áfrica do sul">
        <p>A transição para energias renováveis na África é crucial para permitir limitar o aquecimento global até 2100, dado o crescimento populacional do continente e a forte demanda por desenvolvimento. Carvão, gás e petróleo juntos respondem por 70% da geração elétrica no continente. “Atualmente a eletricidade convencional atrai muito mais recursos do que as energias renováveis na África. Isso se deve a um processo estabelecido que favorece a geração térmica menos consumidora de capital”, diz o relatório “Renewable Energy Market Analysis: Africa and its Regions”, um diagnóstico de 318 páginas, lançado há alguns dias pela agência Irena em colaboração com o Banco Africano de Desenvolvimento (AfDB).</p>
      </div>
    </div>
    ...
    <div class="col s0 m3 yellow lighten-2">
      ...
      <article>
            ...
            <ul>
                <li><a class="black-text" href="#africa">África do Sul</a></li>
                <li><a class="black-text" href="#alemanha">Alemanha</a></li>
                <li><a class="black-text" href="#brasil">Brasil</a></li>
                <li><a class="black-text" href="#china">China</a></li>
                <li><a class="black-text" href="#espanha">Espanha</a></li>
                <li><a class="black-text" href="#india">Índia</a></li>
                <li><a class="black-text" href="#quenia">Quénia</a></li>
            </ul>
        </article>
    </div>
